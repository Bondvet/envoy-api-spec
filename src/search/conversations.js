 ...
 * @apiSuccess {Date} [clients.conversations.closedAt] format: `YYYY-MM-DDTHH:mm:ssZ`
 ...
 * @apiSuccess {Date} clients.conversations.insertedAt format: `YYYY-MM-DDTHH:mm:ssZ`
 ...
 * @apiSuccess {Date} [clients.conversations.messages.deletedAt] format: `YYYY-MM-DDTHH:mm:ssZ`
 * @apiSuccess {Date} clients.conversations.messages.insertedAt format: `YYYY-MM-DDTHH:mm:ssZ`
